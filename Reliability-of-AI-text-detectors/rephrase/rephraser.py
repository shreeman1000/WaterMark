...
with open(os.path.join(args.DUMP, "/raid/home/gourishanker/NLP/WaterMark/WaterMark/Dataset/English/Sir_watermarked_text.pkl"), "rb") as f:
    o2 = pkl.load(f)
...
try:
    for rec in range(p):
        ...
        with open(os.path.join(args.DUMP, f"SIRrephrased{rec}.pkl"), "wb") as f:
            pkl.dump(R, f)
        o2 = R[::]
